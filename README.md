...
Computer engineering student building MCP servers, deploying them to the cloud, and working on MCP security.
...
[![PyPI](https://img.shields.io/pypi/v/efatura-kontrol)](https://pypi.org/project/efatura-kontrol/)
[![license](https://img.shields.io/badge/license-MIT-blue)](https://github.com/BerkantACUN/efatura-kontrol/blob/main/LICENSE)

Validates Turkish GİB e-invoices (UBL-TR) against the tax authority's own XSD and Schematron rules before submission.

### [ifc-ruhsat](https://github.com/BerkantACUN/ifc-ruhsat)

[![PyPI](https://img.shields.io/pypi/v/ifc-ruhsat)](https://pypi.org/project/ifc-ruhsat/)
[![license](https://img.shields.io/badge/license-MIT-blue)](https://github.com/BerkantACUN/ifc-ruhsat/blob/main/LICENSE)

Checks building-permit IFC (BIM) models against Türkiye's digital project regulation.

## Services / Hire me

- **Custom MCP server development** — an MCP server for your API, database or internal tools.
- **Moving stdio MCP servers to the cloud** — packaging a local stdio server as a remote service with Docker and Azure Container Apps.
- **MCP security audit** — reviewing your MCP servers and client configs, delivered as a guardmcp report with findings and fixes.
...
MCP sunucuları geliştiren, bunları buluta taşıyan ve MCP güvenliği üzerine çalışan bir bilgisayar mühendisliği öğrencisiyim.
